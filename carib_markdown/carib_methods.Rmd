...
Based on the 7 factors and constraints we defined for identifying area feasible for offshore mariculture development, we find  `r prettyNum(total_s_area,big.mark = "", digits = 2)`  km^2^, of area, or `r prettyNum(perc_total_area, big.mark = ",", digits =2)` % our study area, suitable for the development of offshore mariculture. Depth was the most constraining factor, `r round(suit_var_table[7,3], digits = 2)`% of our study area fell within a depth range suitable for maricutlure development. `r round(100 - suit_var_table[6,3], digits = 2)`% of our study area was found unsuitable for mariculture development based on relative shipping activity, which was our second largest constraining factor. 

Suitable area  found in the EEZs for all countries except Martinque, St. Martin, and Guadeloupe because of there EEZ wide protected status. The Bahamas EEZ contains the largest area of ocean suitable for mariculture development (`r round(suit_eez_table[9,3]/total_s_area * 100, digits = 2)`% of all suitable area), which can largely be attributed to the large size of its EEZ.

```{r table1, results='asis'}
rownames(suit_eez_table) <- NULL
...
```{r fig.cap = "Areas suitable for offshore mariculutre in the Caribbean"}
