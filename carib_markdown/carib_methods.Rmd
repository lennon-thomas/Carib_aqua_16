...
```{r, eval=F, fig.cap = "Average harvest cycle length (months) by farm"}
knitr::include_graphics(path = paste0(run_dir, 'Figures/harv_length_hist.jpeg'))
```


```{r, eval=F, fig.cap = "Average growth of cobia by month"}
knitr::include_graphics(path = paste0(run_dir, 'Figures/EEZ_avg_growth.png'))
```


```{r, eval=F, fig.height = 5, fig.width = 4, fig.cap = "Comparison of production when all suitable farms are developed, only profitable farms, and only profitable farms with lower feed costs"}
