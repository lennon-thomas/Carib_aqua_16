...
Based on the factors and criteria described in Table 1, we find a total of  `r prettyNum(total_suitable_area,big.mark=",")` km^2^, or `r prettyNum(percent_suitable, digits = 2) ` % of EEZ area in the Caribbean, suitable for offshore aquaculture development (Figure 3).
...
```{r, fig.height = 5, fig.width = 4, fig.cap = "Estimated total production of cobia (mt) for our study area under each of our 5 model scenarios"}
...
Given the current global price of cobia, 19 EEZs contained farms that were profitable after 10 years. Trinidad and Tobago had the highest total NPV, followed by Jamaica.
