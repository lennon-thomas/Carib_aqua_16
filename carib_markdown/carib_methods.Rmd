...
knitr::include_graphics(path = paste0(run_dir, 'Figures/annuity_cntry_disc_boxplot.png'))
```
...
```{r, fig.cap="Figure S5. Cobia supply curves under current feed costs ($1.65/kg) and a 10% reduction in feed cost."}
