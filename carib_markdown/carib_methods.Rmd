...
For both scenarios we examine and compare the following:
...
tmap_arrange(g_antilles_fig, luc_arc_suitable.fig,lee_ant_suitable.fig,less_ant_suitable.fig)
...
rownames(country_suitable) <- NULL
