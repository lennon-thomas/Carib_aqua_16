...
```{r , fig.height = 8, fig.cap = "Figure 2. Estimated total annual production of cobia from all suitable farm sites (panel A) and median production from only profitable farm sites (panel B)"}
