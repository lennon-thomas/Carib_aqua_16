...
Based on the 7 factors and constraints we defined for identifying area feasible for offshore mariculture development, we find  `r prettynum(total_s_area,big.mark = "", digits = 2)`  km^2^, of area, or `r prettynum(perc_total_area, big.mark = ",", digits =2)` % our study area, suitable for the development of offshore mariculture. Depth was the most constraining factor, `r prettynum(suit_var_table$"% of Study Area"[suit_var_table$Layer=='Depth'],big.mark = "", digits = 2) % of our study area fell within a depth range suitable for maricutlure development. `r prettynum(100 - suit_var_table$"% of Study Area"[suit_var_table$Layer=='Depth'],big.mark = "", digits = 2)% of our study area was found unsuitable for mariculture development based on relative shipping activity, which was our second largest constraining factor. 

 Suitable area  found in the EEZs for all countries except Martinque, St. Martin, and Guadeloupe because of there EEZ wide protected status. The Bahamas EEZ contained the largest area of ocean suitable for mariculture culture development, which can largely be attributed to it's large EEZ area ('r prettynum(suit_eez_table[1,3]/total_s_area * 100), big.mark = "", digits = 2)` % of the our total area was found in the Bahamas EEZ.
