...
land = readOGR(dsn=paste0(boxdir,'Carib_aqua_16/Suitability/tmp'),layer="carib_eez_shape",verbose = FALSE)
...
all<-raster(paste0(boxdir,'Carib_aqua_16/Suitability/results/Suitable areas.tif'))
...
```
Based on the factors and criteria described in Table 1, we found a total of  `r prettyNum(Totalarea,big.mark=",")` km^2^, or `r prettyNum(100*Productionrate, digits = 0)`% of EEZ area in the Caribbean, suitable for offshore aquaculture development (Figure 2).
...
table3<-read.csv(paste(boxdir,"Carib_aqua_16/Suitability/results/suitable area by country.csv",sep=""))
table3<-table3[,-1]
set.alignment("center")
