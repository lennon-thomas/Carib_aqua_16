...
Given our estimates of production costs and cobia price, ~ `r prettyNum(main_results[1,3],big.mark=",", digits = 5)`  km^2^  (`r round(main_results[2,3], digits = 2)`% of study area) is economically viable for cobia mariculture, with the potential to produce  `r round(main_results[20,3] / 1e6 / 10, digits = 1)` MMT of cobia annually. 
...
Our findings also support the conclusion that feed accounts for the vast majority of farm operating costs, with the median farm spending `r round(100*main_results[5,3], digits = 0)`% of operating costs on feed. 
