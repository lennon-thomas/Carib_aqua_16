...
1.	Download mapped, monthly MODIST 4 km SST data from January 2005-Dec. 2014 from here: http://oceandata.sci.gsfc.nasa.gov/MODIST/Mapped/Monthly/4km/SST/
In total 120 files will be downloaded.
2.	Download SeaDas tool from here: http://seadas.gsfc.nasa.gov/seadas64/
3.	Load each raw (downloaded in .bz format) monthly SST data file (separately into SeaDas). 
...
North lat bound: 30.167
West long bound: -87.292
South lat bound: 7.375
East long bound: -57.042
