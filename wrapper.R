...
run_name = 'test_Jan_17'    #"calc_0.02" #run name reflects intital stocking density (calculated or fixed)and feed rates (as % body weight)
...
if (run_sim ==TRUE){
  ...
  # Save results ------------------------------------------------------------
   ...
   writeRaster(avg_month_growth, paste0(rundir,'data/avg_month_growth_stack.nc'), format = "CDF", overwrite =TRUE)
   writeRaster(stocking_n, paste0(rundir,'data/initial_stocking_stack.nc'), format = "CDF", overwrite =TRUE)
   writeRaster(harvest_cycles, paste0(rundir,'data/harvest_cycles.nc'), format = "CDF", overwrite =TRUE)
   writeRaster(harvest_cycle_length, paste0(rundir,'data/harvest_cycle_length.nc'), format = "CDF", overwrite =TRUE)
